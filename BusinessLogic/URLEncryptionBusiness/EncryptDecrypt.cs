...
namespace BusinessLogic.URLEncryptionBusiness
{
    public class EncryptDecrypt : IEncryptDecrypt
    {
        ...
        {
            var val = AppSettings.AppSettings.MVCSecret;
        ...
        public string DecryptString(string value)
        {
            ...
            {
                File.AppendAllText("error_log.txt", $"{DateTime.Now}: Error decrypting - {ex.Message}{Environment.NewLine}{ex.StackTrace}{Environment.NewLine}");
            }
            finally
            {
